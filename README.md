...
> Status: **Phase A (pre-flight) — in progress.** See [roadmap](docs/architecture/overview.md).
...
|---|---|---|
| A — Pre-flight | Backups, docs, storage headroom | In progress |
| B — Segmentation | pfSense + VLANs, migrate services | Planned |
